...
public final class HeapAnalyzer {
    ...
    public HeapAnalyzer(@NonNull ExcludedRefs excludedRefs,
        ...
        for (Class<? extends Reachability.Inspector> reachabilityInspectorClass : reachabilityInspectorClasses) {
            try {
                Constructor<? extends Reachability.Inspector> defaultConstructor = reachabilityInspectorClass.getDeclaredConstructor();
    ...
    AnalysisResult checkForLeak(@NonNull File heapDumpFile, @NonNull String referenceKey, boolean computeRetainedSize) {
        ...
        try {
            ...
            // 该引用没有泄漏，在 dump heap的过程中 引用已经清理了
            if (leakingRef == null) {
    ...
    private Instance findLeakingReference(String key, Snapshot snapshot) {
        ...
        //遍历所有的 KeyedWeakReference 对象
        for (Instance instance : refClass.getInstancesList()) {
            List<ClassInstance.FieldValue> values = classInstanceValues(instance);
            //找到 KeyedWeakReference 中的 key属性
